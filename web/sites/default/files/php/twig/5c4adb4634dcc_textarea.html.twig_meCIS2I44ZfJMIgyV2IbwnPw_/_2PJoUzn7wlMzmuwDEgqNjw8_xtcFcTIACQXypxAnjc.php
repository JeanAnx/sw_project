...
($context["required"] ?? null)) ? ("required") : (""))];
        // line 23
        echo "<div";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["wrapper_attributes"] ?? null), "addClass", [0 => "form-textarea-wrapper"], "method"), "html", null, true));
        echo ">
  <textarea";
        // line 24
...
";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/form/textarea.html.twig", "/home/stagiaire/POEJA/drupalCapG/StarWarsProject/web/core/themes/classy/templates/form/textarea.html.twig");
    }
}
