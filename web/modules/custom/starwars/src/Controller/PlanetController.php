...
class PlanetController extends ControllerBase implements ContainerInjectionInterface {
  ...
  /**
   * Page title callback for a starwars_planet  revision.
   *
   * @param int $starwars_planet_revision
   *   The starwars_planet  revision ID.
   *
  ...
  /**
   * Generates an overview table of older revisions of a starwars_planet .
   *
   * @param \Drupal\starwars\Entity\PlanetInterface $starwars_planet
   *   A starwars_planet  object.
   *
   * @return array
  ...
  public function revisionOverview(PlanetInterface $starwars_planet) {
    ...
    $revert_permission = (($account->hasPermission("revert all starwars_planet revisions") || $account->hasPermission('administer starwars_planet entities')));
    $delete_permission = (($account->hasPermission("delete all starwars_planet revisions") || $account->hasPermission('administer starwars_planet entities')));
