 ...
 *   },
 *   base_table = "starship",
 *   data_table = "starship_field_data",
 *   revision_table = "starship_revision",
 *   revision_data_table = "starship_field_revision",
 *   translatable = TRUE,
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/starship/{starship}",
 *     "add-form" = "/admin/structure/starship/add",
 *     "edit-form" = "/admin/structure/starship/{starship}/edit",
 *     "delete-form" = "/admin/structure/starship/{starship}/delete",
 *     "version-history" = "/admin/structure/starship/{starship}/revisions",
 *     "revision" = "/admin/structure/starship/{starship}/revisions/{starship_revision}/view",
 *     "revision_revert" = "/admin/structure/starship/{starship}/revisions/{starship_revision}/revert",
 *     "revision_delete" = "/admin/structure/starship/{starship}/revisions/{starship_revision}/delete",
 *     "translation_revert" = "/admin/structure/starship/{starship}/revisions/{starship_revision}/revert/{langcode}",
 *     "collection" = "/admin/structure/starship",
 *   },
 *   field_ui_base_route = "starship.settings"
 * )
 */
class Starship extends RevisionableContentEntityBase implements StarshipInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the starship owner the
    // revision author.
